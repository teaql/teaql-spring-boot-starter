...
import com.doublechaintech.data.sql.SQLRepository;
...
public class SubQueryParser implements SQLExpressionParser<SubQuerySearchCriteria>{
    ...
    @Override
    public String toSql(UserContext userContext, SubQuerySearchCriteria expression, String idTable, Map<String, Object> parameters, SQLColumnResolver sqlColumnResolver) {
    ...
    private boolean isRequestInDatasource(UserContext pUserContext, SQLColumnResolver pSqlColumnResolver, Repository pRepository) {
